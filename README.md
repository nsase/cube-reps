...
If a solve arrives before its group, History offers a temporary group named with its ID without changing the stored association. The original name appears when the group arrives. Group deletions take precedence over regular edits, including pending renames; affected solves remain available under Unclassified.
