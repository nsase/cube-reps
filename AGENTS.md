...
- `@responsive`を付けたテストは、次のPlaywrightプロジェクトとCSSピクセル単位のviewportで確認する。端末定義やviewportを変更した場合は、この一覧も同時に更新する。
  ...
  | --- | --- | --- |
  | `desktop-wide` | Desktop Chrome | 1440 × 900 |
  | `ipad-mini` | iPad Mini・縦向き | 768 × 1024 |
  | `ipad-mini-landscape` | iPad Mini・横向き | 1024 × 768 |
  | `ipad-pro-11` | iPad Pro 11・縦向き | 834 × 1194 |
  | `ipad-pro-11-landscape` | iPad Pro 11・横向き | 1194 × 834 |
  | `pixel-7` | Pixel 7・縦向き | 412 × 839 |
  | `pixel-7-landscape` | Pixel 7・横向き | 863 × 360 |
